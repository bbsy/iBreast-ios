...
class SelfExamHisService: HttpObjectMapper,HttpCallBack{
    ...
    func objectMap(data:AnyObject)->AnyObject?{
        ...
        var model = SelfExamHisModel(lastId:100,action:1, time: time, imageUrl: obj.valueForKey("imageUrl") as! String, title: obj.valueForKey("name") as! String, detail: obj.valueForKey("password") as! String,addIds:nil,deleteIds:nil,idsForAll:nil)
